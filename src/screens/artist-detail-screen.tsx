...
const MOCK_SONGS: Song[] = [
  { id: '1', title: 'Bang Bang', artist: 'Ariana Grande', image: 'https://upload.wikimedia.org/wikipedia/en/4/47/Ariana_Grande_-_Dangerous_Woman_%28Official_Album_Cover%29.png', duration: '03:19' },
  { id: '2', title: 'The Light Is Coming', artist: 'Ariana Grande', image: 'https://upload.wikimedia.org/wikipedia/en/e/e1/Ariana_Grande_-_Dangerous_Woman_live.jpg', duration: '03:50' },
  { id: '3', title: 'Dangerous Woman', artist: 'Ariana Grande', image: 'https://upload.wikimedia.org/wikipedia/en/4/47/Ariana_Grande_-_Dangerous_Woman_%28Official_Album_Cover%29.png', duration: '03:56' },
];
    ...
    <SafeAreaView className={`flex-1 ${colorScheme === 'dark' ? 'bg-black' : 'bg-white'}`}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text className="text-center text-gray-500 mt-2 text-base">
          {artist.albumCount} Album  |  {artist.songCount} Songs  |  01:25:43 mins
        </Text>
